...
public class Escalier extends AppCompatActivity {
    TextView chrono;
    TextView text;
    int count =0;
    String chier = "Là, un panneau W.C\nPar terre, bien sûr...\nDescendre ou monter ? Vite !";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V){
                {
                    Intent intent = new Intent(Escalier.this, Culdesac2.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V){
                {
                    Intent intent = new Intent(Escalier.this, Ascenseur.class);
                   unregisterReceiver(br);
                    finish();
                    startActivity(intent);
                }
