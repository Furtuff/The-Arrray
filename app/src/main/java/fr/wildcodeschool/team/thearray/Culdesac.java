...
public class Culdesac extends AppCompatActivity {
TextView chrono;
    TextView text;
    int count =0;
    String chier = "C'est un cul-de-sac ! \nJe perds du temps.\nBon, allez, je vais à droite cette fois. Vite !";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_culdesac);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V){
                {
                    Intent intent = new Intent(Culdesac.this, Mamie.class);
